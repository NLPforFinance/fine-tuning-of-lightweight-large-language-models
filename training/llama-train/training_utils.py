...
def train_on_proportion(proportion, tokenizer, bnb_config):
    ...
    training_args = setup_training_args(
        os.path.join(Config.OUTPUT_ROOT, f"llama-{proportion}")
    )
    ...
    model.save_pretrained(os.path.join(Config.OUTPUT_ROOT, f"llama-{proportion}"))
    tokenizer.save_pretrained(os.path.join(Config.OUTPUT_ROOT, f"llama-{proportion}"))
